...
# Below are some common tasks you can perform with the os module:

# Reading and writing file The os module provides functions for opening, reading, and writing files.
...
f = os.open("Use-Lecture-36.txt", os.O_RDONLY)
...
f = os.open("Use-Lecture-36.txt", os.O_WRONLY)
